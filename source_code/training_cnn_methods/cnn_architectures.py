...
class Models:
    ...
    def get_metrics(self):
        ...
        df_train['predict'] = [value for value in y_train_predicted]
        df_train['y_real'] = [value for value in self.y_train]
        ...
        df_test['predict'] = [value for value in y_test_predicted]
        df_test['y_real'] = [value for value in self.y_test]

        df_test.to_csv("response_test.csv", index=False)
        df_train.to_csv("response_train.csv", index=False)
